...
export default function Padding( props ) {
	...
	return (
		<Fragment>
			...
			{ paddingEnableRight && (
				<RangeControl
					label={ __( 'Padding Right', 'team-blocks' ) }
					value={ paddingRight }
					min={ paddingRightMin }
					max={ paddingRightMax }
			...
			{ paddingEnableLeft && (
				<RangeControl
					label={ __( 'Padding Left', 'team-blocks' ) }
					value={ paddingLeft }
					min={ paddingLeftMin }
					max={ paddingLeftMax }
			...
			{ paddingEnableVertical && (
				<RangeControl
					label={ __( 'Padding Vertical', 'team-blocks' ) }
			...
			{ paddingEnableHorizontal && (
				<RangeControl
					label={ __( 'Padding Horizontal', 'team-blocks' ) }
